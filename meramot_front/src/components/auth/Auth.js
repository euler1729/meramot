        ...
        <div className='auth'>
            <div className='auth-container'>
                ...
                <div className='sign-options'>
                    <div onClick={handleSignInGoogle} className='signle-option google'>
                    ...
                    <div onClick={handleSignInGithub} className='signle-option git'>
                    ...
                    <div onClick={handleSignInFacebook} className='signle-option fb'>
